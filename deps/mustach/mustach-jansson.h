 ...
 */
extern int mustach_jansson_file(const char *template, size_t length,
                                json_t *root, int flags, FILE *file);
 ...
 * a other negative value in case of error.
 */
extern int mustach_jansson_fd(const char *template, size_t length, json_t *root,
                              int flags, int fd);
 ...
 * a other negative value in case of error.
 */
extern int mustach_jansson_mem(const char *template, size_t length,
                               json_t *root, int flags, char **result,
                               size_t *size);

/**
 * mustach_jansson_write - Renders the mustache 'template' for 'root' to custom
 ...
 * a other negative value in case of error.
 */
extern int mustach_jansson_write(const char *template, size_t length,
 ...
 * a other negative value in case of error.
 */
extern int mustach_jansson_emit(const char *template, size_t length,
                                json_t *root, int flags,
