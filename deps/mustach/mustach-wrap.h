 ...
 * partial or must return an error code if it failed.
 */
extern int (*mustach_wrap_get_partial)(const char *name,
 ...
 */
extern int mustach_wrap_file(const char *template, size_t length,
 ...
 * a other negative value in case of error.
 */
extern int mustach_wrap_fd(const char *template, size_t length,
                           const struct mustach_wrap_itf *itf, void *closure,
                           int flags, int fd);

/**
 * mustach_wrap_mem - Renders the mustache 'template' in 'result' for an
 * abstract wrapper of interface 'itf' and 'closure'.
 *
 * @template: the template string to instanciate
 * @length:   length of the template or zero if unknown and template null
 * terminated
 ...
 * a other negative value in case of error.
 */
extern int mustach_wrap_mem(const char *template, size_t length,
                            const struct mustach_wrap_itf *itf, void *closure,
 ...
 * a other negative value in case of error.
 */
extern int mustach_wrap_write(const char *template, size_t length,
                              const struct mustach_wrap_itf *itf, void *closure,
 ...
 * a other negative value in case of error.
 */
extern int mustach_wrap_emit(const char *template, size_t length,
                             const struct mustach_wrap_itf *itf, void *closure,
