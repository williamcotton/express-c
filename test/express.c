...
void expressTests(tape_t *t) {
  ...
  //         embeddedFilesCount};
  //     char *fileData = matchEmbeddedFile("demo/public/app.css",
  //     embeddedFiles); t->strEqual("matching file", t->string(fileData), "h");
  //     free(fileData);
  ...
  //                 "<h1>Query String</h1><p>Value 1: 123</p><p>Value 2: 34
  //                 5</p>");
  ...
  //         "body method",
  //         t->post("/put/form123",
  //         "param1=12%2B3&param2=3+4%205&_method=put"),
  //         "<h1>Form</h1><p>Param 1: 12+3</p><p>Param 2: 3 4 5</p>");
  //   });
  ...
  //     t->strEqual("body method", t->post("/delete/form123",
  //     "_method=delete"),
  //                 "<h1>Delete</h1><p>ID: form123</p>");
  //   });
  ...
  //     t->strEqual("set cookie",
  //     t->get("/set_cookie\?session=123\\&user=test"),
  //                 "ok");
  ...
  //     t->strEqual("redirect", t->get("/redirect"), "Redirecting to
  //     /redirected"); t->strEqual("redirect back", t->get("/redirect/back"),
  //                 "Redirecting to back");
  //   });
  ...
  //       t->strEqual("custom request middleware",
  //       t->get("/base/params/blip/m"),
  //                   "super-params-router test blip");
  //       t->strEqual("param value", t->get("/base/params/hip/param_value"),
  //       "hip");
  //     });
